...
"SynColor MLSectionComment		term=standout cterm=NONE ctermfg=7 ctermbg=4 gui=NONE guifg=Blue guibg=Yellow
...
hi matlabCellComment          term=standout cterm=NONE ctermfg=Gray ctermbg=DarkBlue gui=NONE guifg=Blue guibg=Yellow
"below is the original line
"hi def link matlabCellComment          MLSectionComment
